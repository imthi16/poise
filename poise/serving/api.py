...
class InferenceService:
    ...
    def state(self) -> dict:
        ...
        return {
            ...
            "ceiling_c": self.cfg.thermal.temp_max_c,
            "ambient_c": self.cfg.thermal.ambient_c,
            "budget_set": list(self.cfg.depth.budget_set),
            "layer_total": self.cfg.depth.layer_total,
